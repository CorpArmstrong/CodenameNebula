...
event Resolved(IpAddr AddressIp) {
  ...
  DeusExPlayer(GetPlayerPawn()).ClientMessage("Resolved" @ AddressHost @ "to" @ IpAddrToString(AddressIp), 'ScreenTcpLinkWeb');
  DeusExPlayer(GetPlayerPawn()).ClientMessage("Local port is" @ AddressLocalPort, 'ScreenTcpLinkWeb');
...
event ResolveFailed() {
  ...
  DeusExPlayer(GetPlayerPawn()).ClientMessage("Unable to resolve" @ AddressHost, 'ScreenTcpLinkWeb');
